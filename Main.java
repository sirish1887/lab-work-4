...
public class Main {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Clean Code", "Aayush", "9780132350884", 8500.00);
        Magazine mag1 = new Magazine("Tech Monthly", "9780132350885", 3000.00, 42);
        DVD dvd1 = new DVD("Java Fundamentals", "9780132350886", 6000.00, 120);
